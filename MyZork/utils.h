...
enum Actions { GO, PICK, DROP, READ, BREAK, SEE, FILL, OPEN, USE, PUT, QUIT, NOACTION };
...
typedef std::pair<Directions, int> Door;			// A door will be a pair composed of a direction that it leads to and the index of the room he leads to.
